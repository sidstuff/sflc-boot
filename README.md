...
For testing during development, you can build just the initrd (done on Ubuntu), and specify a kernel version (from any supported distro) that is prebuilt for the target architecture.
```sh
